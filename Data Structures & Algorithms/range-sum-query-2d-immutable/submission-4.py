class NumMatrix:
    ...
    def sumRegion(self, row1: int, col1: int, row2: int, col2: int) -> int:
        ...
        return bottomRight - top - left + topLeft #Top-left is added again because the left and top subtract top-left twice because that's the common intersection for both. 